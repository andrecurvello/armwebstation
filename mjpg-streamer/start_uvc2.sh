...
#./mjpg_streamer -o "output_http.so -w ./www" -i "input_uvc.so -d /dev/camera"

/mjpg-streamer/mjpg_streamer -o "/mjpg-streamer/output_http.so -p 8081 -w ./www" -i "/mjpg-streamer/input_uvc.so -d /dev/video14 -r 352x288"
